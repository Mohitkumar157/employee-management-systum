...
function Header() {
  ...
  return (
    <header>
    <div className='header-logout flex justify-between items-center px-2! mx-auto! my-5! md:px-6! py-3! bg-[#1F232A] rounded-[10px] text-white max-w-292.5'>
      <div className="employee-info flex items-center gap-5">
        ...
        <div className="name-designation">
          <h1 className=''><span className='user-name font-semibold '>{activeUser?.currentUser?.name}</span></h1>
